...
namespace AppointmentScheduler.Migrations
{
    ...
    [Migration("20180304221057_Added Appointment entity")]
            ...
            modelBuilder.Entity("AppointmentScheduler.Entities.Appointment", b =>
                {
                    ...
                    b.Property<int>("ScheduledHourID");
            ...
            modelBuilder.Entity("AppointmentScheduler.Entities.Appointment", b =>
                {
                    ...
                    b.HasOne("AppointmentScheduler.Entities.ScheduledHour", "ScheduledHour")
                        .WithMany()
                        .HasForeignKey("ScheduledHourID")
                        .OnDelete(DeleteBehavior.Cascade);
                });
